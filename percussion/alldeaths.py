...
class alldeaths:
    ...
    def read_csv(self, csv_name):
        ...
        template produced with alldeaths.projection_template() is
    ...
    def set_parameters(self, death_stddev):
        ...
        If D is an instance of alldeaths, then the standard deviation
    ...
    def projection_template(self):
        ...
        data loaded into the alldeaths instance.

        The 'Deaths' column is intended to store deaths estimates, and will
        be empty on return from alldeaths.projection_template. The user
        is responsible for filling in the Value column for each row. Once
        completed, it can be passed to alldeaths.likelihood(...) for
